...
Ellipse::Ellipse(double x, double y, double a, double b, double angle,
                 int nbPoints, vector<double> &X, vector<double> &Y,
                 vector<double> &PolarR, vector<double> &PolarTheta) {
