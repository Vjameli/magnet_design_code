...
CXX=g++
main: main.o BFieldThick.o   BFieldThick_Matrix.o Integral.o Ellipse.o Model2.o Model.o  
	$(CXX) $(CFLAGS) -o main main.o BFieldThick.o  BFieldThick_Matrix.o Integral.o Ellipse.o Model2.o Model.o -lilocplex -lconcert -lcplex -lm -lpthread
...
clean:
	rm -f main main.o BFieldThick.o  BFieldThick_Matrix.o  Integral.o Ellipse.o Model2.o Model.o 
